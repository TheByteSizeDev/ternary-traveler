...
You are welcome to work on this for as many days or weeks as you like :smile: _However_, you must push up the work you have done, whatever state it is in, before you leave tomorrow. Here's what I would like you to do:
At ~3:55, make a new branch called `07-10` and merge your work at that point to this branch and push it up.
Then, if you plan to keep working on it, checkout to another branch and do no more work on `07-10`. This will allow us to see how far everyone was able to get in the same timeframe, which will help us immensely in assessing where the class is as a whole.
( Remember, being able to follow instructions from your lead dev will make you a very popular new hire when you start that new job. Practice that skill today :smirk: )
